...
function changeFlowerTex() {
    ...
    if (getTimeZone() === '-12:00') {
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(1.0, 1.0, 1.0, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.98, 0.92, 0.96, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.985, 0.896, 0.939, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.998, 0.809, 0.947, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.788, 0.942, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.98, 0.768, 0.979, 0.15);
        script.textComponent.dropshadowSettings.fill.color = new vec4(0.98, 0.768, 0.979, 1.0);
        //script.textComponent.textFill.color = new vec4(0.98, 0.768, 0.979, 1.0);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.63, 0.984, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(0.977, 0.51, 0.99, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(0.977, 0.49, 0.987, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.439, 0.828, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.443, 0.696, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(0.995, 0.494, 0.644, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.991, 0.539, 0.573, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.987, 0.575, 0.51, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.99, 0.466, 0.457, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.986, 0.583, 0.434, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.983, 0.617, 0.338, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.976, 0.675, 0.205, 0.15);
        ...
        script.BGMaterial.mainPass.edgeColor = new vec4(0.987, 0.589, 0.195, 0.15);
        script.textComponent.dropshadowSettings.fill.color = new vec4(0.987, 0.589, 0.195, 1.0);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.464, 0.186, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(0.99, 0.560, 0.04, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.43, 0.063, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.249, 0.029, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0.095, 0, 0.15);
         ...
         script.BGMaterial.mainPass.edgeColor = new vec4(1, 0, 0, 0.15);
